...
int main(int argc, char *argv[])
{
     ...
     * The vch of file object can be any value, and all the vch of file_objs with the same value means the same audio source.
     * All of the binds should be allocated within the same group.
     * While sending the audio data, you can send to any one of bind fds, and don't care about another fd.
     *
