/**
 * @file encode_force_keyframe.c
 *
 * Support platform: GM8210, GM8287, GM8139
 * This source code is encoder force keyframe sample
 * (此示例为编码时强制I帧程序)
 ...
 */
/**
 * @example encode_force_keyframe.c
 */
#include <stdio.h>
#include <unistd.h>
#include <stdlib.h>
...
static void *encode_thread(void *arg)
{
    ...
    sprintf(filename, "ch%d_%dx%d_force.264", ch, gm_system.cap[ch].dim.width,
