<?php
    ...
    include_once WEBROOT . '/include/constants.php';
    include_once WEBROOT . '/include/app.php';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <p>This Chuangmi is powered by a custom firmware. See <a href="https://github.com/fliphess/chuangmi-720p-hack"</a> for more informations</a>.</p>
